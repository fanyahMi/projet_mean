...
export class AdminSidebarComponent {
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      name: 'Emplacements',
      subItems: [
        { name: 'Liste des boxes', path: '/admin/boxes' },
        { name: 'Attribution', path: '/admin/boxes/assignment' }
      ]
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4.25 6C4.25 5.58579 4.58579 5.25 5 5.25H19C19.4142 5.25 19.75 5.58579 19.75 6C19.75 6.41421 19.4142 6.75 19 6.75H5C4.58579 6.75 4.25 6.41421 4.25 6ZM6.25 10C6.25 9.58579 6.58579 9.25 7 9.25H17C17.4142 9.25 17.75 9.58579 17.75 10C17.75 10.4142 17.4142 10.75 17 10.75H7C6.58579 10.75 6.25 10.4142 6.25 10ZM8.25 14C8.25 13.5858 8.58579 13.25 9 13.25H15C15.4142 13.25 15.75 13.5858 15.75 14C15.75 14.4142 15.4142 14.75 15 14.75H9C8.58579 14.75 8.25 14.4142 8.25 14ZM10.25 18C10.25 17.5858 10.5858 17.25 11 17.25H13C13.4142 17.25 13.75 17.5858 13.75 18C13.75 18.4142 13.4142 18.75 13 18.75H11C10.5858 18.75 10.25 18.4142 10.25 18Z" fill="currentColor"></path></svg>`,
      name: 'Categories',
      subItems: [
        { name: 'Gerer les categories', path: '/admin/categories' },
        { name: 'Nouvelle categorie', path: '/admin/categories/new' }
      ]
    },
    {
